...
object BuildParams {
     ...
     *
     * -PflakyTest=include: run all tests, including flaky tests.
     * -PflakyTest=exclude: run all tests, excluding flaky tests.
     * -PflakyTest=quarantine: run flaky tests only.
     *
     * Default value (if absent) is "include".
     */
    const val FLAKY_TEST = "flakyTest"
